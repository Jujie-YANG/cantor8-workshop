"""Best-effort placeholder for a later ACS check.

ACS means Active Contract Set. The low-level party allocation flow can be
completed without this script.
"""
...
def main() -> int:
    ...
    print("ACS check placeholder")
    print(f"Party ID: {party_id}")
    print(f"Validator API base: {api_base}")
    print("Ask Cantor8 for the exact ACS/query endpoint, then add it here.")
